            ...
            <plugin>
                ...
                <executions>
                    ...
                    <execution>
                        ...
                        <configuration>
                            <!-- 包含要读取的配置文件，目前只支持properties、yaml文件 -->
                            <includes>
                                <include>${project.basedir}/src/main/resources/bootstrap.yml</include>
                            </includes>

                            <!-- 配置要获取资源文件的属性名以及该属性值的引用名 -->
                            <properties>
                                <!-- 从配置文件中获取 ${server.port} 值，并将其值以属性名 "file.server.port" 添加到 MavenProject#Properties 中，可通过 "${file.server.port}" 获取该属性值 -->
                                <server.port>file.server.port</server.port>

                                <!-- 将配置文件中所有的属性和值添加到 MavenProject#Properties 中 -->
                                <all>*</all>
                            </properties>
                        </configuration>
                    </execution>
